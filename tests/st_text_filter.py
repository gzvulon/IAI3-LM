...
class Test(unittest.TestCase):
    ...
    def setUp(self):
        self.short_text = 'A week ago, I ordered my Kindle 2 and when it was delivered, the battery was in critical stage and it would not power on .'
...
#        print '== test_word_filter =='
        res = s_text_filter.word_filter(self.short_text)
        self.assertEqual(res, ['week', 'ago', 'ordered', 'kindle', 'and', 'when', 'was', 'delivered', 'the', 'battery', 'was', 'critical', 'stage', 'and', 'would', 'not', 'power'])
...
#        print res
        self.assertEqual(res, ["dsfkj", 'sdw',  "dff"])
